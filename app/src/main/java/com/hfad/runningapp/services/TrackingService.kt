...
import com.hfad.runningapp.utils.Constants.FASTEST_LOCATION_INTERVAL
import com.hfad.runningapp.utils.Constants.LOCATION_UPDATE_INTERVAL
...
import com.hfad.runningapp.utils.Constants.TIMER_UPDATE_INTERVAL
    ...
    private fun updateLocationTracking(isTracking: Boolean) {
        if (isTracking) {
            if (TrackingUtility.hasLocationPermissions(this)) {
                ...
                println("UPDATE LOCATION: $isTracking")
            }
        } else {
